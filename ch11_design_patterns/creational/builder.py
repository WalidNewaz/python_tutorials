...
class CarDirector:
    @staticmethod
    def build_economy(model: str) -> Car:
        return (
            CarBuilder(model)
            .with_engine("I4", 150)
    ...
    @staticmethod
    def build_performance(model: str) -> Car:
        return (
            CarBuilder(model)
...
economy = CarDirector.build_economy(sport_sedan)
print(economy)
performance = CarDirector.build_performance(sport_sedan)
print(performance)
